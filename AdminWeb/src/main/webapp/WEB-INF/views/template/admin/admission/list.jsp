...
<body class="hold-transition sidebar-mini layout-fixed">
					...
					<div class="card card-info card-outline">
						...
						<div class="card-body">
							...
							<div
								...
								<div class="mb-2">
									<a href=""
										class="btn btn-sm btn-info" id="excelbuttonclick"> Excel </a>
								</div>
							</div>
							<!-- List Content -->
							<form action="" method="GET" class="table-responsive"
								id="form-table">
								<table
									class="table table-bordered table-hover text-nowrap btn-table mb-0" id="table-student-admission">
									<thead>
										<tr>
									...
									<tbody>
                                        <c:forEach var="applicationForm" items="${applicationForm}">
											<tr>
                                                ...
                                                <td>(+84)${applicationForm.schUser.phoneNumber}</td>
    ...
    <script>
         $("#excelbuttonclick").click(function(){
            $("#table-student-admission").table2excel({
                name: "Worksheet Name",
                filename: "TRƯỜNG TRUNG HỌC PHỔ THÔNG NĂNG KHIẾU",
                fileext: ".xls"
            }) 
        });
    </script>
